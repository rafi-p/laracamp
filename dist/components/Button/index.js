...
function Button(props) {
    ...
    if (props.isLoading)
        state = "loading";
    const className = [
        "py-2 px-6 font-medium rounded-full relative appearance-none focus:outline-none transition-all duration-300 inline-flex items-center justify-center select-none overflow-hidden",

...
function Navbar({ children, cta, pathname, className }) {
    ...
    return ((0, jsx_runtime_1.jsx)("header", { className: "shadow-[0px_6px_60px_rgba(22,_28,_51,_0.06)]", children: (0, jsx_runtime_1.jsxs)("div", { className: "px-4 container mx-auto flex justify-between items-center py-8", children: [(0, jsx_runtime_1.jsx)(Brand_1.default, { className: "w-44 h-10 mr-12 flex items-center" }), (0, jsx_runtime_1.jsxs)("button", { className: "relative z-30 w-7 flex lg:hidden flex-col items-center justify-center transition-all gap-y-1 hover:gap-y-2", onClick: () => setMenuActive((prev) => !prev), children: [(0, jsx_runtime_1.jsx)("span", { className: [
                        ...
                        isMenuActive ? "flex fixed inset-0" : "relative hidden md:flex",
                                ...
                                isMenuActive ? "flex" : "md:hidden md:flex-row",
                            ].join(" "), children: react_1.Children.toArray(children).map((menu, i) => ((0, jsx_runtime_1.jsx)("li", { className: "", children: (0, jsx_runtime_1.jsx)(menu.type, { ...menu.props, className: pathname === menu.props.href
                                        ? className.active
                                        : className.idle, children: (0, jsx_runtime_1.jsx)(menu.props.children.type, { className: [
                                            ...
                                            pathname === menu.props.href
                                                ? className.active
                                                : className.idle,
                                        ].join(" "), children: menu.props.children.props.children }) }) }, i))) }), (0, jsx_runtime_1.jsx)("div", { className: [
